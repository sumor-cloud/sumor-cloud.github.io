...
// الحصول على العميل مع حزمة الاتصال
...
// سيرقول السجل إذا كانت العلامة التجارية 'BMW' موجودة بالفعل
...
يمكنك إضافة كائن join إلى تعريف entity لإنشاء انضمام في الجدول.
