...
Ein Datenbank-Connector für MySQL etc. Basierend auf Entity.
...
// Datensatz wird nicht eingefügt, wenn brand 'BMW' bereits vorhanden ist
...
// Datensatz wird aktualisiert, wenn brand 'BMW' bereits vorhanden ist
