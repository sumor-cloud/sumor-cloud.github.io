...
Er kann Logs auf verschiedenen Ebenen ausgeben und Sie können den Bereich, die ID und die Zeitzone anpassen.
...
// Sie werden folgenden Output sehen:
// 2020-01-01 00:00:00.000 TRACE MAIN - Hallo Welt!
```

### Bereich ändern

In manchen Fällen müssen wir Logs kategorisieren. `scope` wird zu diesem Zweck verwendet.
...
In manchen Fällen benötigen wir eine Benutzerkennung. `id` wird zu diesem Zweck verwendet.
...
Die meiste Zeit müssen wir nur Logs einer bestimmten Ebene ausgeben. Dann können wir entscheiden, ob wir sie speichern und anzeigen oder nicht.
