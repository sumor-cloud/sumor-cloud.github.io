...
Puedes agregar un array de índices a la definición de entidad para crear un índice en la tabla, por defecto, creará un índice en el campo `id`.

#### Unión

Puedes agregar un objeto de unión a la definición de entidad para crear una unión en la tabla.
Como en el siguiente ejemplo, creará el campo userId en la entidad de Car.
