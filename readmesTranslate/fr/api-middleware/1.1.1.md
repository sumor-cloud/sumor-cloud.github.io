...
Il peut facilement exposer des fonctions à des API et valider des paramètres
...
Type prend en charge uniquement `number`, `string`, `boolean`, `array`, `object`
...
Le téléchargement de fichiers sera analysé sous forme d'objet suivant :
