...
// obtenir le client avec pool de connexions
...
```js
// requêter les enregistrements avec des options
...
comme l'exemple ci-dessous, il créera le champ userId dans l'entité Car.
