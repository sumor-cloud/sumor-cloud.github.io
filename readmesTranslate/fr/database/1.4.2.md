...
// ne pas insérer l'enregistrement si la marque 'BMW' existe déjà
...
// mettre à jour le modèle de l'enregistrement si la marque 'BMW' existe déjà
...
Comme dans l'exemple suivant, il créera le champ userId dans l'entité Car.
