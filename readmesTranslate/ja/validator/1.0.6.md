...
console.log(messages4) // [ '值需大於5' ]

// translate to zh-TW
const messages5 = validate(parameterInfo, 4, 'zh-TW')
console.log(messages5) // [ '值需大於5' ]
```
...
If you pass error:true, the response will be a SumorError object.  
You can change the language and export JSON support by [@sumor/error](https://www.npmjs.com/package/@sumor/error)
