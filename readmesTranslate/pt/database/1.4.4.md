...
// não inserirá o registro se a marca 'BMW' já existir
...
Você pode adicionar um array de índice à definição de entidade para criar um índice na tabela, por padrão, criará um índice no campo `id`.

#### Unir

Você pode adicionar um objeto de união à definição de entidade para criar união na tabela.
como no exemplo abaixo, irá criar o campo userId na entidade Car.
