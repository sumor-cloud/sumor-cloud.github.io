...
Esta é uma biblioteca short-id para Node.js e para o navegador.  
Você pode facilmente usá-la para gerar um short id a partir de um número.
...
// por padrão, utilizando a regra 0123456789abcdefghigklmnopqrstuvwxyzABCDEFGHIGKLMNOPQRSTUVWXYZ
