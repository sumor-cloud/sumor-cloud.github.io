...
Поскольку данный пакет написан в виде ES модуля,
...
Большую часть времени нам нужно выводить логи определенного уровня. Затем мы можем решить, сохранять и отображать их или нет.
...
const code = {
  ...
  info: {
    USER_LOGIN: 'Пользователь выполняет вход, идентификатор пользователя {id}'
  },
  warn: {
...
logger1.code('USER_LOGIN', { id: 'ПОЛЬЗОВАТЕЛЬ001' })
// Вы увидите следующий вывод:
// 2020-01-01 00:00:00.000 INFO MAIN - Пользователь выполняет вход, идентификатор пользователя ПОЛЬЗОВАТЕЛЬ001
...
logger2.code('USER_LOGIN', { id: 'ПОЛЬЗОВАТЕЛЬ001' })
// Вы увидите следующий вывод:
// 2020-01-01 00:00:00.000 INFO MAIN - Пользователь выполняет вход, идентификатор пользователя ПОЛЬЗОВАТЕЛЬ001
...
logger3.code('USER_LOGIN', { id: 'ПОЛЬЗОВАТЕЛЬ001' })
// Вы увидите следующий вывод:
// 2020-01-01 00:00:00.000 INFO MAIN - Пользователь вошел в систему, идентификатор пользователя ПОЛЬЗОВАТЕЛЬ001
```
